import { createAction, withMatcher, Action, ActionWithPayload } from "../../utils/reducer/reducer.ts";
import { UserData, AdditionalInformation } from "../../utils/firebase/firebase.ts";
import { USER_ACTION_TYPES } from "./userTypes.ts";
