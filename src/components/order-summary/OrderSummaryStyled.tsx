...
export const CheckoutItems = styled.div<{visibility: "block" | "none"}>`
...
export const Total = styled.div<{visibility: "inline-block" | "none"}>`
  display: flex;
  flex-direction: row;
...
`;
export const SummaryContainer = styled.div<{visibility: "column" | "row"}>`
  display: flex;
